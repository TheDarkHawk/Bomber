...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mTheDarkHawj \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border TheDarkHawk
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           YouTube: https://youtube.com/c/TheDarkHawk \e[0m"
    echo -e "\e[4;32m   GitHub: https://github.com/TheDarkHawk \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of Bomber for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By TheDarkHawk > .update
