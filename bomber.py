...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/TheDarkHawk/.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/TheDarkHawk/.git HEAD")
    sys.exit()
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("BOMBER was created by TheDarkHawk")
